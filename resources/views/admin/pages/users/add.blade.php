                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group en">
                                    <label>E-mail </label>
                                    <input type="email" class="form-control" rows="5" name="email" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group en">
                                    ...
                                    <input type="password" class="form-control" rows="5" name="password" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group en">
                                    ...
                                    <input type="text" class="form-control" rows="5" name="username" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group en">
                                    <label>About </label>
                                    <input type="text" class="form-control" rows="5" name="about" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group en">
                                    <label>Phone </label>
                                    <input type="text" class="form-control" rows="5" name="phone" required>
